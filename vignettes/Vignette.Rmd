...
Schmidt D (2022). "float: 32-Bit Floats." R package version 0.3-0, [https://CRAN.R-project.org/](https://CRAN.R-project.org/package=float){.uri}[package=float](https://CRAN.R-project.org/package=float){.uri}.
